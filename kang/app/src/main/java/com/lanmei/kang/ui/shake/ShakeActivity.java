package com.lanmei.kang.ui.shake;
...
public class ShakeActivity extends Activity {
                ...
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        mtoast = Toast.makeText(getApplicationContext(),
                                "抱歉，暂时没有搜索到附近的商家。再试一次吧！", Toast.LENGTH_SHORT);
    ...
    public void startAnim() {   //定义摇一摇动画动画
        ...
        mytranslateanimup1.setStartOffset(durationTime);
        ...
        mytranslateanimdn0.setDuration(durationTime);
        TranslateAnimation mytranslateanimdn1 = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, -0.5f);
        mytranslateanimdn1.setDuration(durationTime);
        mytranslateanimdn1.setStartOffset(durationTime);
