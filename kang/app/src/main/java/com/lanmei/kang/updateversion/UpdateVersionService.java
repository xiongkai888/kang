...
public class UpdateVersionService extends Service {
    ...
    public void onCreate() {
        ...
        updateFile = new File(SDCardUtils.getRootDirectory() + "/updateVersion/" + CommonUtils.getVersionCode() + "kang.apk");
...
//                notification.contentView.setViewVisibility(R.id.btnCancel,View.GONE);
            ...
            public void onFailure(HttpException error, String msg) {
                ...
                if (error.getExceptionCode() == 0) {
                    ...
                    // 更改文字
                    notification.contentView.setTextViewText(R.id.msg, "赛艇达人");
                    // 更改文字
            ...
            public void onLoading(long total, long current, boolean isUploading) {
                ...
                notification.contentView.setTextViewText(R.id.msg, "正在下载：赛艇达人");
                // 更改文字
...
//				notification.contentView.setOnClickPendingIntent(R.id.btnStartStop, pendingIntent);
            ...
            @Override
            public void onStart() {
                notification.contentView.setTextViewText(R.id.msg, "开始下载：赛艇达人");
                nm.notify(titleId, notification);
            }
