...
public class BaiduLocation {
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation) {// GPS定位结果
                ...
                sb.append("\ndescribe : ");
                sb.append("gps定位成功");
                if (wHbdLocaionListener != null)
                    wHbdLocaionListener.bdLocationListener(mLocationClient, location);
                ...
                if (wHbdLocaionListener != null)
                    wHbdLocaionListener.bdLocationListener(mLocationClient, null);
    ...
    public interface WHbdLocationListener {
        void bdLocationListener(LocationClient mLocationClient, BDLocation location);
    }
}
